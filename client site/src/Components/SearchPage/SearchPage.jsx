...
export const SearchPage = () => {
    ...
    const{data, error, loading} = useFetch('localhost:8800/api/hotels')
    ...
    const filterPrice = (e) => {
        ...
        if (e.target.name === "price") {
            if (Number(e.target.value) === 1500) {
                ...
                const filteredAbove1500 = data.filter((el) => {

                    return (Number(el.cheapestPrice) > 1500)
                })
                ...
                const filteredAbove1500 = data.filter((el) => {
                    ...
                    return ((Number(el.cheapestPrice) >= 1000) && (Number(el.cheapestPrice) < 1500));
                })
                setShowData([...filteredAbove1500])
            }
                ...
                const filteredAbove1500 = data.filter((el) => {
                    ...
                    return (Number(el.cheapestPrice) <= 1000)
                })
                setShowData([...filteredAbove1500])
            }
