        ...
        <>
            <div style={{ width: "73%", margin: "auto", backgroundColor: "white", padding: "10px", display: "flex", justifyContent: "space-between" }}>
                ...
                <div>
                    ...
                    <p style={p}>BD-Booking for Travel Agents</p>
                </div>
                <div>
                    <p style={p}>Coronavirus (COVID-19) FAQs</p>
                    <p style={p}>About BD-Booking</p>
            ...
            <div style={{ width: "73%", margin: "auto", textAlign: "center", fontSize: "12px" }}>Copyright © 1996–2021 BD-Booking.com™. All rights reserved.</div>
            <div style={{ fontSize: "13px", padding: "15px", color: "#6B6B6B", textAlign: "center" }}>BD-Booking.com is part of Booking Holdings Inc., the world leader in online travel and related services.</div>
