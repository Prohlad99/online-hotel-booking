    ...
    <div className={styles.login}>
      <div className={styles.nav}>
        ...
        <img
          ...
          src="https://www.shutterstock.com/image-illustration/bangladesh-flag-map-icon-round-600w-2299372727.jpg"
          alt="img"
        ></img>
      </div>
      ...
      <div className={styles.line1}>
        ...
        <p className={styles.p1}>Copyright (2006-2021) – BD-Booking™</p>
      </div>
