...
import barisal from './image/barisal.jpg';
import chattagram from './image/chattagram.jpg';
            ...
            <div className="main">
                ...
                <div className="Cities">
                    ...
                    <div className="manchester">
                        <img src={dhaka} alt="avatar2" />
                        <span className="headmanchester">Dhaka City</span>
                        <p className="childmanchester">1,096 properties</p>
                    </div>
                    <div className="manchester">
                        <span className="headmanchester syl">Sylhet City</span>
                        <p className="childmanchester syl">276 properties</p>
                        <img src={sylhet} alt="avatar2" />
                    </div>
                ...
                <div className="citythree">
                    <div className="manchester">
                        <img src={cox} alt="avatar2" />
                        <span className="headmanchester ">Cox's Bazar</span>
                        <p className="childmanchester ">276 properties</p>
                    </div>
                    <div className="manchester">
                        <img src={chattagram} alt="avatar2" />
                        <p className="childmanchester syl">381 properties</p>
                    </div>
                    <div className="manchester">
                        <img src={barisal} alt="avatar2" />
                        <span className="headmanchester syl">Barisal</span>
                        <p className="childmanchester syl">1,010 properties</p>
                    </div>
                </div>
