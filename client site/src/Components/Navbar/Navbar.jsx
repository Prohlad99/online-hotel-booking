        ...
        <div className={styles.navbarContainer}>
            <div className={styles.navbarUpperSection}>
                ...
                <div className={styles.navbarUpperSectionItems}>
                    <ul>
                        <li className={styles.bdFlag}>
                            Bangladesh
                        </li>
                        <li className={styles.BangladeshiFlag}>
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Flag_of_Bangladesh.svg/1200px-Flag_of_Bangladesh.svg.png" alt="bangladesh's-flag" />
                        </li>
            ...
            <div className={styles.navbarLowerSection}>
                <ul>
                    ...
                    <Tabs onClick={() => setTabs(2)} t={2} tab={tab}>
                        ...
                        <p className={styles.text}>
                            <MyModal btnName="Flight" url="https://www.gozayaan.com/?search=flight&utm_term=biman%20bangladesh%20airline&utm_campaign=&utm_source=adwords&utm_medium=ppc&hsa_acc=8659916254&hsa_cam=20223089682&hsa_grp=151166168553&hsa_ad=660620729939&hsa_src=g&hsa_tgt=kwd-26619512&hsa_kw=biman%20bangladesh%20airline&hsa_mt=b&hsa_net=adwords&hsa_ver=3&gclid=CjwKCAjwvpCkBhB4EiwAujULMv8bgAy1XYSFQ8v9A6b6ifYwxZHqVWy0jKVkUd1_G8dt5Ozk0_SDDhoC-zMQAvD_BwE"/>
                        </p>
                    </Tabs>
                    ...
                    <Tabs onClick={() => setTabs(4)} t={4} tab={tab}>
                        ...
                        <p className={styles.text}>
                            <MyModal btnName="Car Rentals" url="https://carsearchdirect.com/?title=Under%2025%20%20Car%20Rental%20Deals&utm_source=adwords&keyword=under%20car%20rentals&gclid=CjwKCAjwvpCkBhB4EiwAujULMq66rwcvaZGC02Z4iFGLgoUp74_cqO-soxJVsKZMZGaaVPjP_uCTiRoCuyMQAvD_BwE"/>
